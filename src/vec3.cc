...
bool Vec3::NearZero() const {
    ...
    return (std::fabs(Vec3::elements[0]) < kTHRESHOLD) && (std::fabs(Vec3::elements[1]) < kTHRESHOLD) &&
...
Vec3 operator*(double k, const Vec3 &v) { return Vec3(k * v.elements[0], k * v.elements[1], k * v.elements[2]); }
...
Vec3 RandomUnitVector() {
    ...
    while (true) {
        ...
        // of len_sq to avoid under flowing to zero
...
// Reflection of a ray v given a surface normal n is given by the equation below.
